...
export default class GameBoard {
    ...
    objectExist = (character, object) => {
        if (character.moveUp) {
            ...
            return this.grid[y][x].classList.contains(object) || this.grid[y][xb].classList.contains(object);
            ...
            return this.grid[y][x].classList.contains(object) || this.grid[yb][x].classList.contains(object);
